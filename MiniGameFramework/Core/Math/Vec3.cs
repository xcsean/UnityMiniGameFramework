...
namespace MiniGameFramework
{
    public partial struct Vec3 : IEquatable<Vec3>, IFormattable
    {
        ...
        public float this[int index]
        {
            ...
            get
            {
                switch (index)
                {
                    ...
                    case 2: return z;
                    default:
                        throw new IndexOutOfRangeException("Invalid Vec3 index!");
                }
            }
        ...
        // Set x, y and z components of an existing Vec3.
        [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
        ...
        public static float SignedAngle(Vec3 from, Vec3 to, Vec3 axis)
        {
            ...
            float sign = Mathfloat.Sign(axis.x * cross_x + axis.y * cross_y + axis.z * cross_z);
        ...
        {
            return new Vec3(Mathfloat.Min(lhs.x, rhs.x), Mathfloat.Min(lhs.y, rhs.y), Mathfloat.Min(lhs.z, rhs.z));
        }
        ...
        {
            return new Vec3(Mathfloat.Max(lhs.x, rhs.x), Mathfloat.Max(lhs.y, rhs.y), Mathfloat.Max(lhs.z, rhs.z));
        }
        ...
        public static Vec3 zero { [MethodImpl(MethodImplOptionsEx.AggressiveInlining)] get { return zeroVector; } }
        // Shorthand for writing @@Vec3(1, 1, 1)@@
        public static Vec3 one { [MethodImpl(MethodImplOptionsEx.AggressiveInlining)] get { return oneVector; } }
        // Shorthand for writing @@Vec3(0, 0, 1)@@
        public static Vec3 forward { [MethodImpl(MethodImplOptionsEx.AggressiveInlining)] get { return forwardVector; } }
        public static Vec3 back { [MethodImpl(MethodImplOptionsEx.AggressiveInlining)] get { return backVector; } }
        // Shorthand for writing @@Vec3(0, 1, 0)@@
        public static Vec3 up { [MethodImpl(MethodImplOptionsEx.AggressiveInlining)] get { return upVector; } }
        public static Vec3 down { [MethodImpl(MethodImplOptionsEx.AggressiveInlining)] get { return downVector; } }
        public static Vec3 left { [MethodImpl(MethodImplOptionsEx.AggressiveInlining)] get { return leftVector; } }
        // Shorthand for writing @@Vec3(1, 0, 0)@@
        public static Vec3 right { [MethodImpl(MethodImplOptionsEx.AggressiveInlining)] get { return rightVector; } }
        // Shorthand for writing @@Vec3(float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity)@@
        public static Vec3 positiveInfinity { [MethodImpl(MethodImplOptionsEx.AggressiveInlining)] get { return positiveInfinityVector; } }
        // Shorthand for writing @@Vec3(float.NegativeInfinity, float.NegativeInfinity, float.NegativeInfinity)@@
        public static Vec3 negativeInfinity { [MethodImpl(MethodImplOptionsEx.AggressiveInlining)] get { return negativeInfinityVector; } }
        ...
        [System.Obsolete("Use Vec3.forward instead.")]
        public static Vec3 fwd { get { return new Vec3(0F, 0F, 1F); } }
        [System.Obsolete("Use Vec3.Angle instead. AngleBetween uses radians instead of degrees and was deprecated for this reason")]
        public static float AngleBetween(Vec3 from, Vec3 to) { return (float)Math.Acos(Mathfloat.Clamp(Vec3.Dot(from.normalized, to.normalized), -1F, 1F)); }
        [System.Obsolete("Use Vec3.ProjectOnPlane instead.")]
        public static Vec3 Exclude(Vec3 excludeThis, Vec3 fromThat) { return ProjectOnPlane(fromThat, excludeThis); }
    }
}
